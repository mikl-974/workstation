...
print_next_steps() {
  ...
  echo ""
  echo "  4. Pour utiliser la nouvelle identité Age avec sops:"
  echo "       - ajouter le recipient de ${AGE_PUB#$REPO_ROOT/} dans .sops.yaml"
  echo "       - relancer 'sops updatekeys <fichier-secret>' sur les fichiers concernés"
  echo ""
